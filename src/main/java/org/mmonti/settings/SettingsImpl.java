...
public final class SettingsImpl implements Settings {
     ...
     * @param properties
     */
    public SettingsImpl(final Properties properties) {
     ...
     * @param converters
     */
    public SettingsImpl(final Properties properties, final List<Converter<?>> converters) {
    ...
    public boolean hasConverters() {
        return !this.convertersMap.isEmpty();
    }
